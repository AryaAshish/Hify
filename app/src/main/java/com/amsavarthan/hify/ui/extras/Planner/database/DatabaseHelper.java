package com.amsavarthan.hify.ui.extras.Planner.database;
...
import com.amsavarthan.hify.ui.extras.Planner.models.Colour;
import com.amsavarthan.hify.ui.extras.Planner.models.Icon;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "HIFY_DB";
    ...
    public Reminder getNotification(int id) {
        SQLiteDatabase database = this.getReadableDatabase();
        Cursor cursor = database.rawQuery("SELECT * FROM " + NOTIFICATION_TABLE + " WHERE " + COL_ID + context.getString(R.string.limit), new String[]{String.valueOf(id)});
    ...
    private void getDaysOfWeek(Reminder reminder, SQLiteDatabase database) {
        Cursor cursor = database.rawQuery("SELECT * FROM " + DAYS_OF_WEEK_TABLE + " WHERE " + COL_ID + context.getString(R.string.limit1), new String[]{String.valueOf(reminder.getId())});
        cursor.moveToFirst();
