package com.amsavarthan.hify.ui.activities.Extras.Weather.ui.dialog;
...
import com.amsavarthan.hify.ui.activities.Extras.Weather.basic.GeoDialogFragment;
...
import com.amsavarthan.hify.ui.activities.Extras.Weather.utils.helpter.LunarHelper;
    ...
    private void initWidget(View view) {
        ...
        if (daily) {
            String daytimeTxt = weather.dailyList.get(position).weathers[0] + "  "
                    + ValueUtils.buildCurrentTemp(weather.dailyList.get(position).temps[0], false, WeatherExtra.getInstance().isFahrenheit()) + "\n"
            ...
            String nighttimeTxt = weather.dailyList.get(position).weathers[1] + "  "
                    + ValueUtils.buildCurrentTemp(weather.dailyList.get(position).temps[1], false, WeatherExtra.getInstance().isFahrenheit()) + "\n"
            ...
            String text = weather.hourlyList.get(position).weather + "  "
                    + ValueUtils.buildCurrentTemp(weather.hourlyList.get(position).temp, false, WeatherExtra.getInstance().isFahrenheit()) + "\n"
