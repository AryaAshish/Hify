package com.amsavarthan.hify.ui.activities.Extras.Weather.ui.widget.trendView;
...
public class TrendRecyclerView extends RecyclerView {
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawText(
                ValueUtils.buildAbbreviatedCurrentTemp(historyTemps[0], WeatherExtra.getInstance().isFahrenheit()),
                2 * MARGIN_TEXT,
                historyTempYs[0] - paint.getFontMetrics().bottom - MARGIN_TEXT,
                paint);
        canvas.drawText(
                ValueUtils.buildAbbreviatedCurrentTemp(historyTemps[1], WeatherExtra.getInstance().isFahrenheit()),
                2 * MARGIN_TEXT,
