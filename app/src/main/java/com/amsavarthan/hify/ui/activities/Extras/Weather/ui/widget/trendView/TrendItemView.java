...
public class TrendItemView extends View {
    ...
    private void drawMaxiTemp(Canvas canvas) {
        ...
        paint.setShadowLayer(2, 0, 2, shadowColors[2]);
        canvas.drawText(
                ValueUtils.buildAbbreviatedCurrentTemp((int) maxiTemps[1], WeatherExtra.getInstance().isFahrenheit()),
    ...
    private void drawMiniTemp(Canvas canvas) {
        ...
        paint.setShadowLayer(2, 0, 2, shadowColors[2]);
        canvas.drawText(
                ValueUtils.buildAbbreviatedCurrentTemp((int) miniTemps[1], WeatherExtra.getInstance().isFahrenheit()),
                getRTLCompactX((float) (getMeasuredWidth() / 2.0)),
