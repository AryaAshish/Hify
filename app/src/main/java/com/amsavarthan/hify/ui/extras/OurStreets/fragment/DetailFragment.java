...
import com.amsavarthan.hify.ui.extras.OurStreets.data.DetailPresenter;
import com.amsavarthan.hify.ui.extras.OurStreets.data.IntentKeys;
import com.amsavarthan.hify.ui.extras.OurStreets.map.DetailClusterManager;
import com.amsavarthan.hify.ui.extras.OurStreets.map.OnCameraPositionUpdateListener;
import com.amsavarthan.hify.ui.extras.OurStreets.model.Detail;
...
public class DetailFragment extends Fragment implements DataView<Detail> {
    ...
    public static DetailFragment newInstance(@NonNull Context context, @NonNull Gallery gallery,
        ...
        final TransitionInflater inflater;
