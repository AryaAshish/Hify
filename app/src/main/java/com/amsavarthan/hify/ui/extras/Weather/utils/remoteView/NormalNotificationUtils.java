package com.amsavarthan.hify.ui.extras.Weather.utils.remoteView;
...
public class NormalNotificationUtils {
    ...
    public static void buildNotificationAndSendIt(Context context, Weather weather) {
        ...
        LanguageUtils.setLanguage(context, WeatherExtra.getInstance().getLanguage());
    ...
    private static String getWeek(Context context) {
