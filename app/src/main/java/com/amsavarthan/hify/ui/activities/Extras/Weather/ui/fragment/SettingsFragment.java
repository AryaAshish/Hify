package com.amsavarthan.hify.ui.activities.Extras.Weather.ui.fragment;
...
import com.amsavarthan.hify.ui.activities.Extras.Weather.ui.dialog.TimeSetterDialog;
...
public class SettingsFragment extends PreferenceFragment
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference.getKey().equals(getString(R.string.key_background_free))) {
            ...
            WeatherExtra.getInstance().setColorNavigationBar();
            DisplayUtils.setNavigationBarColor(getActivity(), 0);
        } else if (preference.getKey().equals(getString(R.string.key_fahrenheit))) {
            // ℉
            WeatherExtra.getInstance().setFahrenheit(!WeatherExtra.getInstance().isFahrenheit());
            ...
            // imperial units.
            WeatherExtra.getInstance().setImperial(!WeatherExtra.getInstance().isImperial());
            SnackbarUtils.showSnackbar(getString(R.string.feedback_restart));
    ...
    public boolean onPreferenceChange(Preference preference, Object o) {
        if (preference.getKey().equals(getString(R.string.key_ui_style))) {
            ...
            // Card order.
            WeatherExtra.getInstance().setCardOrder((String) o);
            ...
            WeatherExtra.getInstance().setLanguage((String) o);
            SnackbarUtils.showSnackbar(getString(R.string.feedback_restart));
