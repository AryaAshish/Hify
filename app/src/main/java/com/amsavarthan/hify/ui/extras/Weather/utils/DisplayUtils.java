...
public class DisplayUtils {
    ...
    public static void setNavigationBarColor(Activity a, @ColorInt int color) {
        ...
        if (WeatherExtra.getInstance().isColorNavigationBar()
    ...
    public static void setWindowTopColor(Activity a, @ColorInt int color) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            Bitmap topIcon = BitmapFactory.decodeResource(a.getResources(), R.mipmap.weather_logo);
            taskDescription = new ActivityManager.TaskDescription(
                    a.getString(R.string.app_name_weather),
                    topIcon,
                    c);
